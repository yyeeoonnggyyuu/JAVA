...
public class EMSInformationService {
	...
	/* 객체를 DBConnectionInfo -value값으로 받고 있다*/
	...
	public Map<String, DBConnectionInfo> getDbInfos() {return dbInfos;}
	public void setDbInfos(Map<String, DBConnectionInfo> dbInfos) {this.dbInfos = dbInfos;}	
